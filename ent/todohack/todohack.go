...
const (
	// Label holds the string label denoting the todohack type in the database.
	Label = "todo_hack"
	...
	FieldName = "name"
	// Table holds the table name of the todohack in the database.
	Table = "todo_history"
)

// Columns holds all SQL columns for todohack fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o enthistory.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("todohack: invalid enum value for operation field: %q", o)
	}
}

// OrderOption defines the ordering options for the TodoHack queries.
