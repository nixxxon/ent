...
func (ec *executionContext) unmarshalInputTodoHistoryOrder(ctx context.Context, obj interface{}) (ent.TodoHistoryOrder, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "field":
			...
			data, err := ec.unmarshalNTodoHistoryOrderField2ᚖgithubᚗcomᚋnixxxonᚋentdemoᚋentᚐTodoHistoryOrderField(ctx, v)
			if err != nil {
				return it, err
			}
			it.Field = data
...
func (ec *executionContext) unmarshalInputTodoHistoryWhereInput(ctx context.Context, obj interface{}) (ent.TodoHistoryWhereInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "not":
			...
			data, err := ec.unmarshalOTodoHistoryWhereInput2ᚖgithubᚗcomᚋnixxxonᚋentdemoᚋentᚐTodoHistoryWhereInput(ctx, v)
			if err != nil {
				return it, err
			}
			it.Not = data
		case "and":
			...
			data, err := ec.unmarshalOTodoHistoryWhereInput2ᚕᚖgithubᚗcomᚋnixxxonᚋentdemoᚋentᚐTodoHistoryWhereInputᚄ(ctx, v)
			if err != nil {
				return it, err
			}
			it.And = data
...
func (ec *executionContext) unmarshalNTodoHistoryOrderField2ᚖgithubᚗcomᚋnixxxonᚋentdemoᚋentᚐTodoHistoryOrderField(ctx context.Context, v interface{}) (*ent.TodoHistoryOrderField, error) {
	var res = new(ent.TodoHistoryOrderField)
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNTodoHistoryOrderField2ᚖgithubᚗcomᚋnixxxonᚋentdemoᚋentᚐTodoHistoryOrderField(ctx context.Context, sel ast.SelectionSet, v *ent.TodoHistoryOrderField) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNTodoHistoryWhereInput2ᚖgithubᚗcomᚋnixxxonᚋentdemoᚋentᚐTodoHistoryWhereInput(ctx context.Context, v interface{}) (*ent.TodoHistoryWhereInput, error) {
...
func (ec *executionContext) unmarshalOTodoHistoryWhereInput2ᚕᚖgithubᚗcomᚋnixxxonᚋentdemoᚋentᚐTodoHistoryWhereInputᚄ(ctx context.Context, v interface{}) ([]*ent.TodoHistoryWhereInput, error) {
	if v == nil {
		return nil, nil
	}
	var vSlice []interface{}
	...
	for i := range vSlice {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithIndex(i))
		res[i], err = ec.unmarshalNTodoHistoryWhereInput2ᚖgithubᚗcomᚋnixxxonᚋentdemoᚋentᚐTodoHistoryWhereInput(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalOTodoHistoryWhereInput2ᚖgithubᚗcomᚋnixxxonᚋentdemoᚋentᚐTodoHistoryWhereInput(ctx context.Context, v interface{}) (*ent.TodoHistoryWhereInput, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalInputTodoHistoryWhereInput(ctx, v)
